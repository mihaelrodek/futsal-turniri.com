 ...
 */
// v5: UpcomingMatchDto gained knockoutCode + the slot label fields - a
// persisted v4 snapshot renders knockout fixtures as "- vs -" until refetch,
// which is the exact bug this change fixes.
