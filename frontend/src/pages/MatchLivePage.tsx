...
export default function MatchLivePage() {
    ...
    // timeline. Null = the goal dialog is closed.
    ...
    /**
     * Timeline "zatraži snimku gola" tap. Same login gate as the whole-match
     * request (a request is tied to an account), and the goal is labelled here
     * so the dialog can show exactly which one is being ordered - the backend
     * snapshots its own label independently.
     */
