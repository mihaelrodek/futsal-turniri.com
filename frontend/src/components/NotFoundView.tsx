...
import { GhostButton, MonoLabel, PitchBackdrop, PrimaryButton } from "../ui/pitch"
        ...
        <Flex justify="center" py={{ base: "8", md: "14" }}>
            ...
            >
                ...
                <Box position="relative">
                    <MonoLabel color="rgba(255,255,255,0.65)" letterSpacing="0.2em">
                        AUT! LOPTA JE IZVAN IGRE
                    </MonoLabel>
